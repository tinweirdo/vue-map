...
var where = '"objectId"=' + id2 + ' or "globalId"=' + "'" + id + "'";
...
$.getJSON("../../2d.json", (data) => {
    layer_config = data.map.operationallayers.filter(item => item.name === '监测设备')
...
function getpopupHtml(feature) {
    ...
    $.getJSON("popup_device.json", "", function (jsondata) {
        ...
        document.getElementById("popTitle").innerHTML = feature.properties["name"] || "";
    })
}
